...
public class ProductMain {
    ...
    {
        String[] hardwares = { "32인치커브드 디스플레이", "기계식키보드", "버티컬마우스" };
        products[0] = new Desktop("lenovo=12345", "씽크패트 12345", "레노바", 2_000_000, "윈도우 11", hardwares);
    ...
    /**
     * 1. products를 순회하면서 타입별 info메소드를 호출하세요.
     */
    public void test1() {
    ...
    /**
     * 2. Product#productInfo메소드를 override하고(제품별 info메소드호출),
     * instanceof분기처리 없이 동일한 결과출력하기 (동적바인딩)
     */
    public void test2() {
        for (int i = 0; i < products.length; i++) {
