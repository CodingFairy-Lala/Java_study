...
public class Rectangle extends Shape {
	...
	public Rectangle(Point point, int width, int height) {
		points = new Point[4];
		points[0] = point;
		points[1] = new Point(point.getX() + width, point.getY());
		points[2] = new Point(point.getX() + width, point.getY() + height);
		points[3] = new Point(point.getX(), point.getY());
		this.width = width;
		this.height = height;
	}
	...
	public Rectangle(Point leftTop, Point rightBottom) {
		...
		points[3] = new Point(leftTop.getX(), leftTop.getY());
